...
'''
def _printObj(obj, max_depth=3, max_length=50, current_depth=0):
    ...
    # Handle sequences (list, tuple, etc.)
        ...
        items = [_printObj(x, max_depth, max_length, current_depth + 1) for x in list(obj)[:max_length]]
    ...
    # Handle dictionaries
        ...
        items = [f"{_printObj(k, max_depth, max_length, current_depth + 1)}: {_printObj(v, max_depth, max_length, current_depth + 1)}" 
    ...
    # Handle other objects
        ...
        items = [f"{k}={_printObj(v, max_depth, max_length, current_depth + 1)}" 
...
'''
    print out nested object, useful for debugging
    @param obj object to print out
    @param obj_name string to print out describing the obj
'''
def safe_print_obj(obj, obj_name):
        ...
        try:
           result = _printObj(obj, max_depth, max_length)
           print(result)
